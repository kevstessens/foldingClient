...
gulp.paths = {
  dist: 'www',
  distAssets: 'www/assets',
  distResources: 'www/resources',
  jsFixFiles: ['!app/**/*.spec.js', '!app/bower_components/**/*.js', '!app/**/*-const.js', 'app/**/*.js'],
  jsFiles: ['!app/**/*.spec.js', '!app/bower_components/**/*.js', 'app/**/*.js'],
  jsWatchFiles: ['app/modules/**/*.js'],
